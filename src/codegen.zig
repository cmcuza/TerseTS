...
pub fn main(init: std.process.Init) !void {
    const io = init.io;
    try generate_source_code(io, "src/integration_tests.zig", build_integration_tests);
}

/// Generate a file at `output_path` with source code created by `code_generator` at build time.
fn generate_source_code(io: Io, output_path: []const u8, code_generator: fn (writer: *Writer) Error!void) !void {
...
fn build_integration_tests(writer: *Writer) !void {
    const header =
